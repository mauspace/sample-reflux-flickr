...
var _componentsRangeSlider = require('./components/RangeSlider');

var _componentsRangeSlider2 = _interopRequireDefault(_componentsRangeSlider);
...
var App = _react2['default'].createClass({
  ...
  render: function render() {
    return _react2['default'].createElement(
      'div',
      null,
      _react2['default'].createElement(_componentsHeader2['default'], { text: "" }),
      _react2['default'].createElement(
        'div',
        { className: "center-block trim" },
        _react2['default'].createElement(_componentsRangeSlider2['default'], { label: "Number of Image", min: 0, max: 100, step: 1, onChange: this.rangeChangeHandler })
      ),
      _react2['default'].createElement(_componentsImageGrid2['default'], null)
    );
  }
});
...
},{"./actions/ImageActions":1,"./components/Header":3,"./components/ImageGrid":4,"./components/RangeSlider":5,"react":161}],3:[function(require,module,exports){
"use strict";
...
},{"../stores/ImageStore":181,"react":161,"reflux":162}],4:[function(require,module,exports){
"use strict";
            ...
            return _react2["default"].createElement(
                ...
                this.state.imagestore.map(function (image) {
                    return _react2["default"].createElement(
                        ...
                        _react2["default"].createElement(
                            "a",
                            { href: 'https://farm' + image.farm + '.static.flickr.com/' + image.server + '/' + image.id + '_' + image.secret + '_b.jpg' },
                            _react2["default"].createElement("img", { src: 'https://farm' + image.farm + '.static.flickr.com/' + image.server + '/' + image.id + '_' + image.secret + '_s.jpg'
                            })
                        )
                    );
                }),
...
},{"../stores/ImageStore":181,"react":161,"reflux":162}],5:[function(require,module,exports){
"use strict";
...
var RangeSlider = _react2["default"].createClass({
    ...
    componentDidMount: function componentDidMount() {
        ...
        $slider.Link('lower').to('-inline-<div class="tooltip"></div>', function (value) {
            $(this).html('<span>' + value.substr(0, value.length - 1) + '</span>');
        });
        $slider.on({
...
},{"../stores/ImageStore":181,"react":161,"reflux":162}],6:[function(require,module,exports){
...
var ImageStore = _reflux2["default"].createStore({
  ...
  fetchList: function fetchList(values) {
    var pageN = values;
    var tags = ['2010-09-04', '2011-09-04', '2012-04-04', '2013-04-04', '2014-04-04', '2015-04-04'];
...
},{"../actions/ImageActions":1,"reflux":162}]},{},[2]);
